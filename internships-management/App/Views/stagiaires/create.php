<div class="container mt-5">
    ...
    <?php endif; ?>
    <form action="/stagiaire/store" method="post">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control <?= isset($errors['mot_de_passe']) ? 'is-invalid' : '' ?>" id="mot_de_passe" name="mot_de_passe" required>
